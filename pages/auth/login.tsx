...
import { AccountLayout } from '@components/common/layout';
...
import s from 'stylesheets/login.styles.module.scss';
...
export default function LoginPage() {
  ...
  if (data.view === 'mobile') {
    return (
      <AccountLayout title="ورود | فروشگاه اینترنتی تیمچه" tabTitle="ورود به حساب کاربری">
